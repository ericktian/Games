...
'''
  Passed: OOOOOOOOO.XXXXO.OOXXXXX.OOXXXXO.OOXXXXXXOOOOOX..XXXXOOO.XXXXXXX. x  in 0.2028s
  Passed: OX.O.XX.OXXXXXXOOOXOOOOXOOXXOOX.OOOXOXXOO.OOOXXX.OOOOOXXXOO.OX.. o  in 0.3479s
  Passed: X.OXXX..X.OOXXX.XOOXOXOOXXOOXOOOXXOXOXOOXOXOOXOOOOOOOO....OOOOO. X  in 0.6676s
  Passed: ...OOOOO..XXXXXO.XOOOOXOXOOOOOXOXOOOXOXOXOOXOXOO..OOOOXO..OOOO.X O  in 3.5347s
  Passed: ..XXXXXX.OOXXOOXXXOXOOOX..OOOXOX..OOOXOX.OOOXOOXOOOXXOOX..OXXO.. x  in 34.242s
  Passed: XXXXOOOOOXXXOXO.OXXOOXOXOXXXOX.XOOXXX..XOOOXXX..OOOOOX..OOO..... o  in 32.667s
  Passed: XXXXXXXXXXXXOXXXXXXOXOXXXXOXOOOXXXOOOO.XXXOO.O.XXXO..O..X....... x  in 50.345s
'''
...
def legalMoves(game, move):
    ...
    #
    #                 if wrapsAround(current, current + x):
    #                     break
    #                 current += x
    #                 if current < len(game) and current >= 0 and game[current] == '.':
    #                     pos = current
    #
    #         if pos != '':
    #             legal.add(pos)
